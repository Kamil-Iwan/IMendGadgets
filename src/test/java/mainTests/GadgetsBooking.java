...
//			wait2.until(ExpectedConditions.elementToBeClickable(gadget));
			...
			String gadgetName = driver.findElement(By.xpath("//span[@id='gadget-selection-boxes']/span[" + i + "]"))
					.getText();
			...
			int repairsSize = driver
					.findElements(By.cssSelector("#" + gadgetsCorrectName + "-selection-boxes .wpcf7-list-item"))
					.size();
			...
			for (int r = 1; r <= randomNumber; r++) {
				...
				driver.findElements(By.cssSelector("#" + gadgetsCorrectName + "-selection-boxes .wpcf7-list-item"))

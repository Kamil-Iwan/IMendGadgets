...
public class iPadBooking extends base {
	...
	public void checkiPadBookingPage() throws IOException, InterruptedException {
		...
		for (int x = 1; x <= iPadButtons; x++) {
			driver.get(prop.getProperty("ipad"));
			driver.findElement(
					By.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipad-selection-boxes']/span[" + x + "]"))
					.click();

			String ipadName = driver.findElement(By.xpath(
					"//span[@class='wpcf7-form-control wpcf7-radio ipad-selection-boxes']/span[" + x + "]/label/span"))
					.getText();
			...
			for (int r = 1; r <= randomNumber; r++) {
				...
				if (x == 1) {
					...
					driver.findElements(By.cssSelector("." + ipadNameNoSpace + " .wpcf7-list-item")).get(randomRepair)
							.click();
			...
			WebElement bookRepairDynamic = driver
					.findElement(By.cssSelector("div[data-id='" + ipadNameNoSpace + "'] .btn"));
			...
			if (isProceedWithBookingPresent) {
				...
				if (isPresent) {
					...
					System.out.println(ipadName + "- BOOKING STEP 3 PAGE ERROR!!!!!!");
				}
			}

			else {

				System.out.println(ipadName + "- BOOKING STEP 2 PAGE ERROR!!!!!");
		...
		for (int z = 1; z <= iPadMiniButtons; z++) {
			...
			driver.findElement(By
					.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipad-mini-selection-boxes']/span[" + z + "]"))
					.click();

			String ipadMiniName = driver.findElement(
					By.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipad-mini-selection-boxes']/span[" + z
							+ "]/label/span"))
					.getText();
			...
			// save number of repairs to a variable
			List<WebElement> iPadMiniAllRepairs = driver.findElements(
					By.cssSelector("#" + ipadMiniNameCorrectFormat + "-selection-boxes .wpcf7-list-item"));
			...
			for (int y = 1; y <= randomNumberMini; y++) {
				...
				driver.findElements(By.cssSelector("." + ipadMiniNameCorrectFormat + " .wpcf7-list-item"))
						.get(randomRepairMini).click();
			}

			// run a correct script depending whether the xpath link is written as
			// 'iPadMini' or 'iPadmini'
			List<WebElement> bookRepairCapitalM = driver
					.findElements(By.cssSelector("div[data-id='" + ipadMiniNameNoSpace + "'] .btn"));

			if (bookRepairCapitalM.size() > 0) {

				WebElement bookRepairDynamic = driver
						.findElement(By.cssSelector("div[data-id='" + ipadMiniNameNoSpace + "'] .btn"));
				...
				WebElement bookRepairDynamic = driver
						.findElement(By.cssSelector("div[data-id='" + ipadMiniNameCorrectFormat + "'] .btn"));
		...
		for (int a = 1; a <= iPadAirButtons; a++) {
			driver.get(prop.getProperty("ipadair"));
			driver.findElement(
					By.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipadair-selection-boxes']/span[" + a + "]"))
					.click();

			String ipadAirName = driver.findElement(
					By.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipadair-selection-boxes']/span[" + a
							+ "]/label/span"))
					.getText();
			...
			// save number of repairs to a variable
			List<WebElement> iPadMiniAllRepairs = driver
					.findElements(By.cssSelector("#" + ipadAirNameNoSpace + "-selection-boxes .wpcf7-list-item"));
			int repairsSize = iPadMiniAllRepairs.size();
			...
			for (int y = 1; y <= randomNumberMini; y++) {
				...
				driver.findElements(By.cssSelector("." + ipadAirNameNoSpace + " .wpcf7-list-item"))
						.get(randomRepairMini).click();
			}

			// click on Book Repair
			WebElement bookRepairDynamic = driver
					.findElement(By.cssSelector("div[data-id='" + ipadAirNameNoSpace + "'] .btn"));
		...
		for (int p = 1; p <= iPadProButtons; p++) {
			driver.get(prop.getProperty("ipadpro"));
			driver.findElement(
					By.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipadpro-selection-boxes']/span[" + p + "]"))
					.click();

			String ipadProName = driver.findElement(
					By.xpath("//span[@class='wpcf7-form-control wpcf7-radio ipadpro-selection-boxes']/span[" + p
							+ "]/label/span"))
					.getText();
			...
			// save number of repairs to a variable
			List<WebElement> iPadMiniAllRepairs = driver
					.findElements(By.cssSelector("#" + ipadProNameNoSpace + "-selection-boxes .wpcf7-list-item"));
			int repairsSize = iPadMiniAllRepairs.size();
			...
			for (int y = 1; y <= randomNumberMini; y++) {
				...
				driver.findElements(By.cssSelector("." + ipadProNameNoSpace + " .wpcf7-list-item")).get(randomRepairPro)
						.click();
			}

			// click on Book Repair
			WebElement bookRepairDynamic = driver
					.findElement(By.cssSelector("div[data-id='" + ipadProNameNoSpace + "'] .btn"));

...
public class LaptopBooking extends base{
	...
	public void checkLaptopBookingProcess() throws IOException, InterruptedException {
		...
		for (int i=1; i<=laptopsSize; i++) {
			...
			String laptopName = driver.findElement(By.xpath("//span[@id='laptop-selection-boxes']/span[" + i + "]")).getText();
			...
			driver.findElement(By.cssSelector("div[data-id='" + laptopNameLowCase + "'] input[type='text']")).sendKeys("test");
			...
			int repairsSize = driver.findElements(By.cssSelector("#" + laptopNameLowCase + "-laptops-selection-boxes .wpcf7-list-item")).size();
			...
			for (int r = 1; r <=randomNumber; r++) {
				...
				driver.findElements(By.cssSelector("#" + laptopNameLowCase + "-laptops-selection-boxes .wpcf7-list-item")).get(randomRepair).click();
			...
			/////////////////Select a random Repair Type/////////////
			int repairsSize = driver.findElements(By.cssSelector("#" + laptopNameLowCase + "-selection-boxes .wpcf7-list-item")).size();
			...
			for (int r = 1; r <=randomNumber; r++) {
				...
				driver.findElements(By.cssSelector("#" + laptopNameLowCase + "-selection-boxes .wpcf7-list-item")).get(randomRepair).click();

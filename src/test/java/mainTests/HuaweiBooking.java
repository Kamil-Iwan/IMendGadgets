...
public class HuaweiBooking extends base {

	@Test
	public void HuaweiheckBookingProcess() throws IOException, InterruptedException {
		...
		// Huawei page - check if service page opens up for each phone
		for (int i = 1; i <= huaweiButtons; i++) {
